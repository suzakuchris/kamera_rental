        ...
        $.each(data, function(x,y){
            ...
            rows += `
                <tr>
                    ...
                    <td>
                        <div class="btn-group">
                            <a target="FORM_BUNDLE" class="btn btn-outline-primary d-flex align-items-center" href="{{route('master.product_bundle.edit')}}/`+y.bundle_id+`"><i class="bi bi-pencil me-2"></i>Edit</a>
